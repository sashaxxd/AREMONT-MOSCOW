...
<div id="euro_block13">
    <div id="block13">
        <div class="row">
            ...
            <div class="col-2">
                <div id="euro_Text8">
                    <span id="euro_uid7"><?= $economy->title ?></span>
                </div>
                <hr id="Line1">
                <div id="euro_Text9">
                    <span id="euro_uid8"><?= $economy->text ?> </span>
                </div>
                <div class="tabs  vertical">

                    <ul class="tabs__caption">
                        <?php $i=0;  foreach ($EconomyOne as  $item): ?>
                            <?php $i++ ?>
                            <li
                                <?php   if($i == 1): ?>
                                    class="active"
                ...
                <div class="tabs  vertical">
                    ...
                    <ul class="tabs__caption">
                        <?php $i=0;  foreach ($EconomyTwo as  $item): ?>
                            <?php $i++ ?>
                            <li
                                <?php   if($i == 1): ?>
                                    class="active"
                ...
                <div class="tabs  vertical">
                    ...
                    <ul class="tabs__caption">
                        <?php $i=0;  foreach ($EconomyThree as  $item): ?>
                            <?php $i++ ?>
                            <li
                                <?php   if($i == 1): ?>
                                    class="active"
