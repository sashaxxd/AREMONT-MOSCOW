...
<div id="euro_block13">
    <div id="block13">
        <div class="row">
            ...
            <div class="col-2">
                <div id="euro_Text8">
                    <span id="euro_uid7"><?= $standard->title ?></span>
                </div>
                <hr id="Line1">
                <div id="euro_Text9">
                    <span id="euro_uid8"><?= $standard->text ?> </span>
                </div>
                <div class="tabs  vertical">

                    <ul class="tabs__caption">
                        <?php $i=0;  foreach ($StandardOne as  $item): ?>
                            <?php $i++ ?>
                            <li
                                <?php   if($i == 1): ?>
                                    class="active"
                ...
                <div class="tabs  vertical">
                    ...
                    <ul class="tabs__caption">
                        <?php $i=0;  foreach ($StandardTwo as  $item): ?>
                            <?php $i++ ?>
                            <li
                                <?php   if($i == 1): ?>
                                    class="active"
                ...
                <div class="tabs  vertical">
                    ...
                    <ul class="tabs__caption">
                        <?php $i=0;  foreach ($StandardThree as  $item): ?>
                            <?php $i++ ?>
                            <li
                                <?php   if($i == 1): ?>
                                    class="active"
